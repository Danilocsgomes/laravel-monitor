...
<input type="text" name="frequency" placeholder="frequency" value="{{ $endpoint->frequency ?? old('frequency') }}"
...
<button type="submit"
    class="text-black bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800 my-4">Enviar</button>
